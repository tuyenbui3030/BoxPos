        ...
        <div class="container-xxl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="text-muted mt-1">Manage your customer database with advanced filtering and search</div>
                </div>
                    ...
                    <div class="btn-list">
                        <button wire:click="toggleFilters" class="btn btn-outline-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <path d="M4 4h16v2.172a2 2 0 0 1 -.586 1.414l-4.414 4.414v5l-6 2v-7l-4.414 -4.414a2 2 0 0 1 -.586 -1.414v-2.172z"/>
                            </svg>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input wire:model.live.debounce.300ms="search" type="text" class="form-control" placeholder="Search customers...">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                                        <label class="form-selectgroup-item flex-fill">
                                            <input wire:model.live="filterCustomerType" type="radio" name="customerType" value="all" class="form-selectgroup-input" checked>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input wire:model.live="filterOnlyWithDebt" type="checkbox" class="form-check-input" id="filterDebt">
                                        <label class="form-check-label" for="filterDebt">Only customers with debt</label>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-icon mb-2">
                                        ...
                                        <input id="datepicker-icon-prepend" class="form-control" placeholder="Select date range" readonly>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                <thead>
                                    <tr>
                                        <th class="w-1">
                                            <input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select all customers">
                                        </th>
                                        <th>Customer</th>
                                        <th>Contact</th>
                                        <th>Type</th>
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="flex-fill">
                                                        ...
                                                        <div class="text-muted">
                                                            ...
                                                            @if($customer->customer_group)
                                                                <span class="badge bg-azure-lt ms-1">{{ $customer->customer_group }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                ...
                                                @if($customer->formatted_total_sales_minus_returns != $customer->formatted_total_sales)
                                                    <div class="text-muted">
                                                        <small>Net: ${{ $customer->formatted_total_sales_minus_returns }}</small>
                                                    </div>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-ghost-secondary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        Actions
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a wire:click="viewCustomer({{ $customer->id }})" class="dropdown-item" href="#">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                        ...
                                                        <a wire:click="editCustomer({{ $customer->id }})" class="dropdown-item" href="#">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                        ...
                                                        @if($customer->phone_number)
                                                            <a href="tel:{{ $customer->phone_number }}" class="dropdown-item">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                                    <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2"/>
                                                                </svg>
                                            ...
                                            <td colspan="8" class="text-center py-5">
                                                <div class="empty">
                                                    ...
                                                    <p class="empty-subtitle text-muted">
                                                        Try adjusting your search or filter criteria, or add a new customer to get started.
                                                    </p>
                        ...
                        @if($customers->hasPages())
                            <div class="card-footer d-flex align-items-center">
                                <p class="m-0 text-muted">
                                    Showing <span class="badge bg-secondary fw-normal">{{ $customers->firstItem() }}</span> 
                                    to <span class="badge bg-secondary fw-normal">{{ $customers->lastItem() }}</span> 
                                    of <span class="badge bg-secondary fw-normal">{{ $customers->total() }}</span> results
                                </p>
