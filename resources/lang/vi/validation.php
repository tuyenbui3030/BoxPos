...
return [
    ...
    */
    ...
    'ascii' => 'Trường :attribute chỉ được chứa các ký tự và biểu tượng chữ và số một byte.',
    ...
    'gte' => [
        'array' => 'Trường :attribute phải có :value mục hoặc hơn.',
        'file' => 'Trường :attribute phải lớn hơn hoặc bằng :value kilobytes.',
        'numeric' => 'Trường :attribute phải lớn hơn hoặc bằng :value.',
        'string' => 'Trường :attribute phải có :value ký tự hoặc hơn.',
    ],
    ...
    'max' => [
        'array' => 'Trường :attribute không được có hơn :max mục.',
        'file' => 'Trường :attribute không được lớn hơn :max kilobytes.',
        'numeric' => 'Trường :attribute không được lớn hơn :max.',
        'string' => 'Trường :attribute không được có hơn :max ký tự.',
    ],
    'max_digits' => 'Trường :attribute không được có hơn :max chữ số.',
