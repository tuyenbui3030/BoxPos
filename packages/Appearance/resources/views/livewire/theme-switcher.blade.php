<div class="nav-item d-flex">
    ...
    <a href="#" wire:click.prevent="toggleTheme" class="nav-link px-0 hide-theme-light" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Enable light mode" data-bs-original-title="Enable light mode">
...
<script>
// Minimal JavaScript - only for immediate DOM updates
document.addEventListener('livewire:init', () => {
    // Apply current theme immediately to prevent flash
    document.documentElement.setAttribute('data-bs-theme', @js($theme));
