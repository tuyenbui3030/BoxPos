...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cash_categories', function (Blueprint $table) {
            ...
            $table->foreignId('parent_id')->nullable()->constrained('cash_categories')->onDelete('cascade');
            ...
            $table->boolean('is_system')->default(false)->comment('System category (cannot be deleted)');
